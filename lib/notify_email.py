        ...
        try:
            ...
            if settings.NOTIFY_EMAIL_USERNAME != '':
                if settings.NOTIFY_EMAIL_USETLS:
                    ...
                    s.starttls()
                s.ehlo()
                s.login(settings.NOTIFY_EMAIL_USERNAME,
